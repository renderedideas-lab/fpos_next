...
override PACKAGE_NAME=fpos_next
override PACKAGE_VERSION=1.0.alpha
ifeq ($(CPU_OS_TARGET),i386-linux)
override TARGET_UNITS+=system main gdt
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override CLEAN_FILES+=src/*.elf *.iso *.img *.bin initrd/sys/core
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override CLEAN_FILES+=src/*.elf *.iso *.img *.bin initrd/sys/core
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override COMPILER_OPTIONS+=-Aelf -n -O3 -Xd -CX -XXs -Tlinux -Si -va
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-Aelf -n -O3 -Xd -CX -XXs -Tlinux -Si -va
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override COMPILER_TARGETDIR+=src
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override COMPILER_TARGETDIR+=src
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override COMPILER_UNITTARGETDIR+=src
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override COMPILER_UNITTARGETDIR+=src
endif
